...
SELECT nome_agencia DISTINCT  FROM deposito;
...
SELECT DISTINCT nome_cliente FROM deposito WHERE nome_agencia='PUC' 
AND nome_cliente NOT IN (SELECT DISTINCT nome_cliente FROM emprestimo WHERE nome_agencia='');
...
WHERE nome_agencia ='Pampulha' GROUP BY nome_cliente, nome_agencia
