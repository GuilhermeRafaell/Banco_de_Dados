...
SELECT	C.NOME_CLIENTE, C.CIDADE_CLIENTE, D.NOME_AGENCIA, D.NUMERO_CONTA, 
		SUM(D.SALDO_DEPOSITO) AS DEP
FROM CLIENTE AS C NATURAL left OUTER JOIN DEPOSITO AS D
GROUP BY C.NOME_CLIENTE, D.NOME_AGENCIA, D.NOME_AGENCIA ,D.NUMERO_CONTA
ORDER BY C.NOME_CLIENTE, D.NOME_AGENCIA, D.NOME_AGENCIA ,D.NUMERO_CONTA
...
SELECT	C.NOME_CLIENTE, C.CIDADE_CLIENTE, E.NOME_AGENCIA, E.NUMERO_CONTA, 
